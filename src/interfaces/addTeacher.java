...
public class addTeacher extends javax.swing.JFrame {
    ...
    public addTeacher() {
      ...
      public void tableload(){
        ...
        try {
            String sql="SELECT teachers_id,name,contact_number,age,grade,subject,national_id,address,extra FROM teacher";
        ...
        try {
            String sql="SELECT * FROM teacher WHERE name LIKE '%"+src+"%' " ;
            pst=conn.prepareStatement(sql);
            rs=pst.executeQuery();
            jTable1.setModel(DbUtils.resultSetToTableModel(rs));
        ...
        String teacher_id=jLabel12.getText();
        String name= jTextField2.getText();
        String contact_number=jTextField3.getText();
        String age=jTextField4.getText();
        String grade=jTextField9.getText();
        String subject=jTextField5.getText();
        String national_id=jTextField6.getText();
        String address=jTextField7.getText();
        String extra=jTextField8.getText();
        
        try {
            String sql = "UPDATE teacher SET name='"+name+"',contact_number='"+contact_number+"',age='"+age+"',grade='"+grade+"',subject='"+subject+"',national_id='"+national_id+"',address='"+address+"',extra='"+extra+"'  WHERE teachers_id='"+teacher_id+"' ";
            pst = conn.prepareStatement(sql);
            pst.execute();
     ...
     public void tabledata(){
      ...
      public void insert(){
       ...
       national_id=jTextField6.getText();
       address=jTextField7.getText();
       extra=jTextField8.getText();
       
        try {
            
            String sql = "INSERT INTO teacher(name,contact_number,age,grade,subject,national_id,address,extra)VALUES ('"+name+"','"+contact_number+"','"+age+"','"+grade+"','"+subject+"','"+national_id+"','"+address+"','"+extra+"')";
           pst = conn.prepareStatement(sql);
           pst.execute();
        ...
        int check;
        check =JOptionPane.showConfirmDialog(null, "Do you want to DELETE this details ? ");
        
          if(check==0){
          String teacher_id=jLabel12.getText();
              try {
                  String sql;
                  sql="DELETE FROM teacher WHERE teachers_id='"+teacher_id+"'";
                  pst=conn.prepareStatement(sql);
                  pst.execute();
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Add New Teacher");
        ...
        jPanel3.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(81, 29, -1, -1));
        ...
        jPanel3.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(164, 29, -1, -1));
        ...
        jPanel3.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(255, 29, -1, -1));

        jButton4.setText("Clear");
        jPanel3.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(342, 29, -1, -1));
        ...
        jPanel3.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1131, 29, -1, -1));
        ...
        setSize(new java.awt.Dimension(1261, 719));
